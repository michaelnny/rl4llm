...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            r'The final answer is: $\boxed{(x - 2)(x + 2)(x^2 + 4)(x^4 + 16)}$',
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            r'The final answer is $\boxed{\frac{5\sqrt{3}}{3}}$',
            r'\frac{5 \sqrt{3}}{3}',
            1.0,
        ),
        (r'is matching ground truth \( \boxed{y = x + 2} \)', 'y = x+2', 1.0),
        (
            r'Therefore, the final answer is that each boy receives \(\boxed{\$52}\).',
            '52',
            1.0,
        ),
        (
            r'Therefore, the common difference of the arithmetic sequence is \( \boxed{\frac{1}{2}} \).',
            r'\frac{1}{2}',
            1.0,
        ),
        (
        ...
        (
            r"The 158th marble is $\boxed{\text{gray}}. That's my final answer.",
            r'\text{gray}',
            1.0,
        ),
        (r'The final answer is $\boxed{24,000}$.', '24{}000', 1.0),
        (
            r'Thus, the difference is \(\boxed{\frac{16}{3}}\).',
            '\tfrac{16}3',
            1.0,
        ),
        ...
        (
            r'So, the final answer is $\boxed{\frac{2469}{20000}}$.',
            r'\dfrac{2469}{20,!000}',
            1.0,
        ),
        (r'最终答案是 $\boxed{-\frac{1}{2}}$。', r'-\tfrac12', 1.0),
        (
            r'最终答案是 $\boxed{\frac{5\sqrt{3}}{3}}$。',
            r'\frac{5 \sqrt{3}}{3}',
            1.0,
        ),
        ...
        (
            r'第 158 个大理石是 $\boxed{\text{灰色}}$。这是我的最终答案。',
            r'\text{灰色}',
            1.0,
        ),
        ...
        (
            r'所以，最终答案是 $\boxed{\frac{2469}{20000}}$。',
            r'\dfrac{2469}{20,!000}',
            1.0,
        ),
        ...
        (
            r'根据计算，$\boxed{x}$ 的值是 $\boxed{\frac{3}{4}}$。',
            r'\frac{3}{4}',
            1.0,
        ),
