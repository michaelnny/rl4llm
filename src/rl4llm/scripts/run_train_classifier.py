"""Script to train a small coherent classification model on a single GPU."""
...
def parse_args():
    ...
    parser.add_argument(
        '--config-file',
        type=str,
        default='./configs/coherent_classification_config.yaml',
        # required=True,
...
def main():
    """Starts coherent classification training loop."""
